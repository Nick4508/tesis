...
\newcommand{\nombrealumno}{Nicolás Rodríguez Berrios}
\newcommand{\nombreprofesor}{Julio Sotelo}
\newcommand{\nombrecorreferente}{Joaquín Mura}
...
A mi mamá y abuela, por la preocupación y el apoyo, porque sin ellas no sería lo que soy.

A los profesores que han influido positivamente en mi vida, en especial a mi profesor jefe de primero medio y de matemáticas en el colegio, que sin sus palabras y apoyo no hubiera tomado este camino.

A mi yo de niño, que nunca soñó con llegar a este instante, hemos sufrido y sido felices pero estamos aquí, avanzando y siguiendo.

A todos lo niños de la ``pobla'' que sueñan con salir de ahí, el futuro puede ser incierto, pero luchar y seguir adelante es tal vez la única forma que existe.
...
En agradecimientos a mi mamá y mi abuela, que me dieron todo en la vida y facilitaron mi vida como estudiante. A mis tías que se preocuparon por mi cuando fue necesario. A mi prima mayor, que con su ejemplo me mostró lo que debía hacer para sacar la carrera adelante.

A mi profesor guía, gracias por tomar mi primera idea de memoria y mostrarme otro camino equivalente, por la buena disposición y el acompañamiento a lo largo de este camino, este viaje de aprendizaje y desarrollo me ha hecho feliz.

A los profesores que influyeron positivamente en este camino, siempre me acordaré de todo el bien que me aportaron.

A mis amigos de la universidad que a través de salidas, tiempo de estudio, almuerzos y más cosas, hicieron más ameno el paso por esta. A mis amigos de la vida que me han dado su apoyo a lo largo de los años, en especial cuando no creía en este instante.
